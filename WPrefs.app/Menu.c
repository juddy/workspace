...
static void createPanel(_Panel * p)
{
...

	{
		...
		data = putNewItem(panel, pad, CommandInfo, _("Exit Workspace"));
...

	{
		...
		data->param.directory.directory =
		    "/usr/share/Workspace/Themes /usr/local/share/Workspace/Themes $HOME/.workspace/Library/Workspace/Themes";
		...
		data->param.directory.directory =
		    "/opt/kde2/share/wallpapers /usr/share/Workspace/Backgrounds $HOME/.workspace/Library/Workspace/Backgrounds";
		data->param.directory.stripExt = 1;
	...
	WMSetLabelText(label, _("Enter the path for a file containing a menu\n"
				...
				"~/.workspace/Library/Workspace/menu\n" "or\n" "/usr/bin ~/xbin"));
	...
	WMInsertListItem(panel->icommandL, 3, _("Exit Workspace"));
	WMInsertListItem(panel->icommandL, 4, _("Exit X Session"));
	WMInsertListItem(panel->icommandL, 5, _("Restart Workspace"));
