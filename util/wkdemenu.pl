...
#
#
# This script, made for users of Workspace (http://workspace.info) is to
...
#
# Usage: kde2workspace.pl [ Options... ]
#
#        Options:
#
...
#
# When the script is run, it will write out a proper Workspace "External
...
#    then type: $HOME/.kde2workspace.menu   into the "Menu Path/Directory List"
#    textbox.
...
# Workspace, working well with the "Generated Submenu" feature.
#
#
...
# so that they do not break the Menu parser in Workspace.
#
...
$menufile = "$ENV{'HOME'}/.kde2workspace.menu";
...
# the tree and generates the menu output to be used by Workspace.
sub process_dir {
