#!/bin/sh
#
# Place applications to be executed when Workspace is started here.
...
# by the Workspace session restoring mechanism. For that, you should
...
# running.
#
# Workspace will wait until this script finishes, so if you run any
