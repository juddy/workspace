	...
	("Wygląd",
		...
		("Tło",
			("Jednolite",
               	...
               	("Niebieski",         EXEC, "wdwrite Workspace WorkspaceBack '(solid, '#505075')'"),
				("Indigo",            EXEC, "wdwrite Workspace WorkspaceBack '(solid, '#243e6c')'"),
				("Głęboko Niebieski", EXEC, "wdwrite Workspace WorkspaceBack '(solid, '#224477')'"),
               	("Fioletowy",         EXEC, "wdwrite Workspace WorkspaceBack '(solid, '#554466')'"),
               	("Pszeniczny",        EXEC, "wdwrite Workspace WorkspaceBack '(solid, 'wheat4')'"),
               	("Ciemno Szary",      EXEC, "wdwrite Workspace WorkspaceBack '(solid, '#333340')'"),
               	("Winny",             EXEC, "wdwrite Workspace WorkspaceBack '(solid, '#400020')'")
			),
			("Cieniowane",
				("Zachód Słońca",         EXEC, "wdwrite Workspace WorkspaceBack '(mvgradient, deepskyblue4, black, deepskyblue4, tomato4)'"),
				("Niebo",                 EXEC, "wdwrite Workspace WorkspaceBack '(vgradient, blue4, white)'"),
    			("Cieniowany Niebieski",  EXEC, "wdwrite Workspace WorkspaceBack '(vgradient, '#7080a5', '#101020')'"),
				("Cieniowane Indigo",     EXEC, "wdwrite Workspace WorkspaceBack '(vgradient, '#746ebc', '#242e4c')'"),
			   	("Cieniowany Fioletowy",  EXEC, "wdwrite Workspace WorkspaceBack '(vgradient, '#654c66', '#151426')'"),
    			("Cieniowany Pszeniczny", EXEC, "wdwrite Workspace WorkspaceBack '(vgradient, '#a09060', '#302010')'"),
