/*
 * Definiowanie Menu Głównego dla Workspacea
 ...
 *	RESTART [<window manager>] - restart Workspacea albo start innego
 *			                     manadżera okien
 ...
 *                 Workspacea, wtedy zapamiętywanie wszystkich ustawień
 ...
 *  INFO - Wyświetlenie informacji o Workspaceze
 *
