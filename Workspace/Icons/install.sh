INST_DIR="~/.workspace/Library/Workspace/IconSets"
ICONS="xetos-icons"
ICONSET="xetos.iconset"
# quick and dirty script to install the icons & iconset for Workspace
echo "Copying Iconset file to Default location; ~/.workspace/Library/Workspace/IconSets"
	mkdir $INST_DIR &&  echo "Copying Icons to default location (~/.workspace/Library/Icons/itomatOS)"
